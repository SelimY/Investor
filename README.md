...
- **`investor.html`** — Uygulamanın güncel sürümü (v0.13.4). Doğrudan tarayıcıda açılabilir; FSA desteği için `https://` veya `localhost` üzerinden servis edilmesi önerilir.
