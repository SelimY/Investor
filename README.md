...
- **`investor.html`** — Uygulamanın güncel sürümü (v0.12.6). Doğrudan tarayıcıda açılabilir; FSA desteği için `https://` veya `localhost` üzerinden servis edilmesi önerilir.
